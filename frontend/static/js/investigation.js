...
async function selectCase(incidentId) {
    ...
    try {
        ...
        document.getElementById('case-meta').textContent = `Assigned to: ${inc.assigned_analyst} • Target User: EMP-${inc.employee_id}`;
        ...
        await loadActivityTimeline(inc.employee_id);
    } catch (err) {
