    ...
    <div className="min-h-screen grid md:grid-cols-2" style={{ background: "var(--color-bg)" }}>
      ...
      >
        ...
        <div>
          <h2 className="text-3xl font-bold text-white leading-tight max-w-sm">
            Behavioral intelligence for insider risk.
          </h2>
          <p className="text-sm mt-3 max-w-sm" style={{ color: "var(--sidebar-text)" }}>
            Baseline every employee's behavior, surface statistical anomalies, and route findings to the right team — before they become incidents.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center p-6">
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          ...
          <p className="text-sm mb-7" style={{ color: "var(--color-text-muted)" }}>Sign in to your insider threat console</p>
          ...
          <div className="relative mb-6">
            ...
            <input type="password" name="password" value={form.password} onChange={handleChange} required className="input-field pl-9" />
          </div>

          <div className="flex justify-end -mt-3 mb-5"><a href="/forgot-password" className="text-xs font-medium" style={{ color: "var(--color-primary)" }}>Forgot password?</a></div>
          ...
          <p className="text-xs text-center mt-5" style={{ color: "var(--color-text-muted)" }}>
            ...
            <a href="/register" className="font-medium" style={{ color: "var(--color-primary)" }}>Create one</a>
          </p>
        </form>
      </div>
    </div>
